...
if "global_scores" not in args.input_file and "distributions" not in args.input_file:    
    raise Exception("Please use a distributions or global-scores csv as input")
...
# get order
positive_skews = df.loc[df>.75].sum()
